...
export async function POST(req: NextRequest) {
  try {
    ...
    const { message, sessionId, subject, forceReasoning, forceWebSearch } = body as {
      message?: string;
      sessionId?: string;
      subject?: string;
    ...
    const response = await chatWithTutor(message, history, { subject, forceReasoning, forceWebSearch });
